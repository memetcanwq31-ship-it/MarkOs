    ...
    def _cmd_tree(self, args):
        ...
        if shutil.which("dpkg"):
            try:
                ...
                pass
        left = C_RED + KALI_BANNER.splitlines()[0] + C_RESET
        art = f"""\
...
"""
    ...
    def _cmd_apt(self, args):
        ...
        if args[0] == "install" and len(args) > 1:
            ...
            # katalogda görünmesi için durum değişmedi; gerçek kurulum: sudo apt install <araç>
        if args[0] == "update":
    ...
    def _cmd_free(self, args):
        ...
        try:
            ...
            return (f"              toplam   kullanılan  boş\n"
                    f"Bellek:       {total:>6}M     {used:>6}M   {free:>6}M\n")
        except Exception as e:
            return f"free: {e}\n"
